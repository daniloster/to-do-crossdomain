...
(function(){
    var scripts = document.getElementsByTagName('script'), currentScript, componentName;
    for (var i = 0, len = scripts.length; i < len; i++) {
        currentScript = scripts[i];
        componentName = currentScript.getAttribute('data-crossdomain-component');
        if (!!componentName) {
            break;
        }
    }
    appSettings.componentName = componentName.split(',');
})();
