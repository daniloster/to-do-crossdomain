...
var baseUrl = 'http://localhost:7076',
//var baseUrl = 'https://to-do-crossdomain-daniloster.c9.io',
    appSettings = {
...
(function(){
    var scripts = document.getElementsByTagName('script'), currentScript;
    try {
      for (var i = 0, len = scripts.length; i < len; i++) {
          currentScript = scripts[i];
          if (!appSettings.componentName.length) {
              appSettings.componentName = currentScript.getAttribute('data-crossdomain-component').split(',');
          }
          if (!appSettings.applyForAllDocument) {
              appSettings.applyForAllDocument = currentScript.getAttribute('data-wrap-html');
              appSettings.applyForAllDocument = appSettings.applyForAllDocument === "true";
          }
    ...
    appSettings.applyForAllDocument = appSettings.applyForAllDocument === true || appSettings.applyForAllDocument === undefined;
...
var require = {
    ...
    paths: {
        ...
        'to-do': 'components/common/toDo/toDo'
    },
    shim: {
        xdomain: {
            deps: ['xhook']
